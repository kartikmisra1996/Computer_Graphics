...
public class CanvasDOFCam implements GLEventListener, Interactor {
	...
	public void display(GLAutoDrawable drawable) {
		...
		// TODO OBJECTIVE 1: See that this display call needs these viewing and
		...
		if ( focusSelectRequest ) {
		    ...
		    if ( selector.select( drawable, mousePoint ) ) {
				...
				// TODO OBJECTIVE 5: Set the desired focus distance based on the selected point
				// in the world
	...
	private void drawAccumulated(GLAutoDrawable drawable) {
		...
		for (int i = 0; i < N; i++) {
			...
			// TODO OBJECTIVE 7: See how different projections are averaged together for
			// your DOF view in this method
			gl.glMatrixMode(GL2.GL_PROJECTION);
			gl.glLoadIdentity();
