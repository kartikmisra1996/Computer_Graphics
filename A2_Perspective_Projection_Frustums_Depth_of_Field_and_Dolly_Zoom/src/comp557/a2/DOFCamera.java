...
public class DOFCamera {
	...
	public void setupProjection( GLAutoDrawable drawable, int i ) {
    	...
    	double l = -drawable.getSurfaceWidth()/2;
        double r = drawable.getSurfaceWidth()/2;
        double b = -drawable.getSurfaceHeight()/2;
        double t = drawable.getSurfaceHeight()/2;
        ...
        frustumMatrix = new FlatMatrix4d();
	}
	...
	public void setupViewingTransformation( GLAutoDrawable drawable, int i ) {
        ...
        gl.glTranslated(0,0,-focalLength.getValue());
	...
	public void drawFocusPlane( GLAutoDrawable drawable ) {
		...
		//double e = eyeDesired.getX();
		double e = 10;

		gl.glColor3d(1, 0, 0);
		double f = focalLength.getValue();
		double fl = -drawable.getSurfaceWidth()/2 * (e - f) / e;
		double fr = drawable.getSurfaceWidth()/2 * (e - f) / e;
		double fb = -drawable.getSurfaceHeight()/2 * (e - f) / e;
		double ft = drawable.getSurfaceHeight()/2 * (e - f) / e;

		gl.glPushMatrix();
		gl.glTranslated(0, 0, f);
		gl.glBegin(GL.GL_LINE_LOOP);
		gl.glVertex3d(fl, fb, 0);
		gl.glVertex3d(fl, ft, 0);
		gl.glVertex3d(fr, ft, 0);
		gl.glVertex3d(fr, fb, 0);
		gl.glEnd();
		gl.glPopMatrix();
	...
	public void drawSensorPlane( GLAutoDrawable drawable ) {
	    ...
	    gl.glVertex3d(-drawable.getSurfaceWidth()/2,-drawable.getSurfaceHeight()/2,0);
        gl.glVertex3d(-drawable.getSurfaceWidth()/2, drawable.getSurfaceHeight()/2,0);
        gl.glVertex3d(drawable.getSurfaceWidth()/2, drawable.getSurfaceHeight()/2,0);
        gl.glVertex3d(drawable.getSurfaceWidth()/2,-drawable.getSurfaceHeight()/2,0);
	    gl.glEnd();
