...
public class MeshDrawHeatGeo {
	...
	private int specularShininessID; //shine for glsl
	...
	public void init( GL2 gl ) {
		...
		specularShininessID = state.getUniformLocation(gl, "shine");
    ...
    public void drawVBOs( GL2 gl ) {
        ...
        //shine
        gl.glUniform1i(specularShininessID, shininess.getValue());
