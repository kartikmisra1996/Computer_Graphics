...
public class MeshProcessingApp implements SceneGraphNode, Interactor {
    ...
    private String[] soupFiles = {
    		"meshdata/bunnyLowRes.obj",	//0
    		"meshdata/icosahedron.obj",	//1
    		"meshdata/icosphere2.obj",	//2
    		"meshdata/icosphere6.obj",	//3
    		"meshdata/torusSmall.obj",	//4			// has quads
    		"meshdata/torus.obj",		//5			// has quads
    		"meshdata/headtri.obj",		//6
    		"meshdata/cow.obj",			//7
    		"meshdata/bunny.obj",		//8
            "meshdata/human.obj",		//9			// has quads
    		"meshdata/cube.obj",		//10		// should preserve sharp features in display
    		"meshdata/cube2obj.obj",	//11		// should preserve sharp features in display
    		"meshdata/werewolf.obj",	//12 		// has quads
        };
    
    public MeshProcessingApp() {    
        loadMesh( soupFiles[whichSoup] );
        EasyViewer ev = new EasyViewer("COMP 557 Geodesics in heat Kartik Misra 260663577", this, new Dimension(400, 400), new Dimension(600, 650) );
