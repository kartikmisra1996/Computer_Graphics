...
public abstract class GraphNode {
    ...
    LinkedList<GraphNode> childList = new LinkedList<GraphNode>();
    ...
    public JPanel getControls() {
    	if ( dofs.isEmpty() && childList.isEmpty() ) return null;
    ...
    /**
     * Recursively collects all the degrees of freedom for use in creating key poses.
     * @param degreesOfFreedom
     */
    public void getDOFs( Collection<DoubleParameter> degreesOfFreedom ) {
    	degreesOfFreedom.addAll( this.dofs );
    	for ( GraphNode n : childList ) {
			n.getDOFs(degreesOfFreedom);
		}
    }
